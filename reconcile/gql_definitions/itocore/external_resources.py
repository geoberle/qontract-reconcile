...
class NamespaceTerraformResourceIotThingV1(NamespaceTerraformResourceAWSV1):
    region: Optional[str] = Field(..., alias="region")
    policy: Json = Field(..., alias="policy")
    certificate_validity_period_hours: int = Field(..., alias="certificate_validity_period_hours")


class NamespaceTerraformProviderResourceAWSV1(NamespaceExternalResourceV1):
    provider: str = Field(..., alias="provider")
    provisioner: AWSAccountV1 = Field(..., alias="provisioner")
    resources: list[Union[NamespaceTerraformResourceIotThingV1, NamespaceTerraformResourceAWSV1]] = Field(..., alias="resources")
...
class TerraformIOTCoreResourcesQueryData(ConfiguredBaseModel):
    namespaces: Optional[list[NamespaceV1]] = Field(..., alias="namespaces")


def query(query_func: Callable, **kwargs: Any) -> TerraformIOTCoreResourcesQueryData:
    """
    ...
    Returns:
        TerraformIOTCoreResourcesQueryData: queried data parsed into generated classes
    """
    raw_data: dict[Any, Any] = query_func(DEFINITION, **kwargs)
    return TerraformIOTCoreResourcesQueryData(**raw_data)
