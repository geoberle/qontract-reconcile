...
from reconcile.utils.jobcontroller.models import JobConcurrencyPolicy, JobStatus, K8sJob
...
class K8sJobController:
    ...
    # def get_job_logs_as_string(self, job: K8sJob) -> str:
    #     return self.oc.job_log_as_string(
    #         namespace=self.namespace,
    #         name=job.name(),
    #     )
